...
// import adminMenu from "@/assets/json/adminMenu.json";
import verifierMenu from "@/assets/json/verifierMenu.json";
...
export const loginApi = (params: any) => {
  return http.post(BaseUrl + `/auth/backgroundLogin`, params, { noLoading: true });
...
export const logoutApi = () => {
  return http.post(BaseUrl + `/auth/exit`);
};
